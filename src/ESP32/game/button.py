...
button_pin_1 = Pin(23, Pin.IN, Pin.PULL_UP)  # Bouton A
button_pin_2 = Pin(2, Pin.IN, Pin.PULL_UP)   # Bouton B
button_pin_3 = Pin(18, Pin.IN, Pin.PULL_UP)  # Bouton C
button_pin_4 = Pin(19, Pin.IN, Pin.PULL_UP)  # Bouton D
